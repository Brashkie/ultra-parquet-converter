...
pythonCheck.on('close', (code) => {
  if (code !== 0) {
    console.log('⚠️  Python 3 no detectado. Por favor instala Python 3.8 o superior.');
    console.log('   Descarga: https://www.python.org/downloads/\n');
    return;
  }

  console.log('✅ Python 3 detectado\n');
...
pythonCheck.on('error', () => {
  console.log('⚠️  Python 3 no detectado en el PATH.');
